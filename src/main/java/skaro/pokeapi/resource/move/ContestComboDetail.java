...
public class ContestComboDetail {
	 ...
	 * @param useBefore a list of {@link NamedApiResource<Move>} moves
	 */
	 ...
	 * @param useAfter a list of {@link NamedApiResource<Move>} moves
	 */
	...
	/**
	 * Checks whether the ContestComboDetail is equal to another object
	...
	/**
	 * Generate a hash code for the ContestComboDetail
	...
	/**
	 * Get the string representation of the ContestComboDetail
